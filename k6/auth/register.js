...
export default function () {
    ...
    const payload = JSON.stringify({
        name: `user_${__VU}_${__ITER}`, // Unique username per VU and iteration
        email: `user_${__VU}_${__ITER}_${Math.random()}@example.com`,
    ...
    const response = http.post('http://localhost:8000/auth/register', payload, params);
